...
Shader "Bright"
{
	Properties
	{
		...
		_PannerSpeed("PannerSpeed", Range( 0 , 10)) = 0
		_BrightTilingX("BrightTilingX", Range( 0 , 10)) = 0
		_Mask("Mask", 2D) = "white" {}
		_BrightTilingY("BrightTilingY", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			uniform float _BrightTilingX;
			uniform float _BrightTilingY;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult23 = (float2(_PannerSpeed , 0.0));
				float2 appendResult24 = (float2(_BrightTilingX , _BrightTilingY));
				float2 texCoord9 = IN.texcoord.xy * appendResult24 + float2( 0,0 );
				float2 panner8 = ( 1.0 * _Time.y * appendResult23 + texCoord9);
...
/*ASEBEGIN
Version=18900
343;73;1053;535;3209.519;1265.18;3.271207;True;False
Node;AmplifyShaderEditor.RangedFloatNode;26;-1814.333,-212.3531;Inherit;False;Property;_BrightTilingY;BrightTilingY;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1815.728,-293.155;Inherit;False;Property;_BrightTilingX;BrightTilingX;9;0;Create;True;0;0;0;False;0;False;0;1.01;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1597.784,-112.0519;Inherit;False;Property;_PannerSpeed;PannerSpeed;8;0;Create;True;0;0;0;False;0;False;0;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;24;-1500.876,-247.1816;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-1302.492,-269.3962;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;23;-1269.616,-135.7304;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1191.012,-523.4601;Inherit;True;Property;_Brillo;Brillo;12;0;Create;True;0;0;0;False;0;False;None;cfe7919cdc24b1a4eaaac38bb9cdcca5;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;14;-1036.203,-1008.808;Inherit;True;Property;_Mask;Mask;10;0;Create;True;0;0;0;False;0;False;None;024e2d98af687bf4c99e8ea718b45c4f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;-1014.533,269.2076;Inherit;True;Property;_Texture0;Texture 0;14;0;Create;True;0;0;0;False;0;False;None;84508b93f15f2b64386ec07486afc7a3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;5;-927.1837,514.7209;Inherit;True;Property;_mask;mask;13;0;Create;True;0;0;0;False;0;False;None;596678c53fd54a640bf95ba7dfafd092;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1237.183,60.25005;Inherit;True;Property;_base;base;15;0;Create;True;0;0;0;False;0;False;None;80ab37a9e4f49c842903bb43bdd7bcd2;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=D7A6122BE50159CB36F17B9D686BA91514799B1D