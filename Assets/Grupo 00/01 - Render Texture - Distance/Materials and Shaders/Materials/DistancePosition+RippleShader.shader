...
Shader "Distance"
{
	Properties
	{
		...
		_RippleSpeed("_RippleSpeed", Float) = 0
		_RippleFrequency("_RippleFrequency", Float) = 0
		_Texture1("Texture 0", 2D) = "white" {}
		_RippleStartTime("_RippleStartTime", Float) = 0
		_TextureTiling1("Texture Tiling", Range( 1 , 10)) = 1
		_PanSpeed1("PanSpeed", Range( 0 , 14)) = 0
		_PanDir1("PanDir", Vector) = (0,0,0,0)
		_FlowMap1("FlowMap", 2D) = "white" {}
		_DistortionWeight1("DistortionWeight", Range( 0 , 1)) = 0
		_RippleAmplitude("_RippleAmplitude", Float) = 0
	...
	SubShader
	{
		...
		uniform float _TextureTiling1;
		uniform sampler2D _FlowMap1;
		uniform float _DistortionWeight1;
		...
		{
			float2 temp_cast_0 = (_TextureTiling1).xx;
			float2 uv_TexCoord90 = i.uv_texcoord * temp_cast_0;
			float2 lerpResult98 = lerp( uv_TexCoord90 , ( (tex2D( _FlowMap1, uv_TexCoord90 )).rg + uv_TexCoord90 ) , _DistortionWeight1);
			float2 panner99 = ( 1.0 * _Time.y * ( _PanDir1 * _PanSpeed1 ) + lerpResult98);
			o.Albedo = tex2D( _Texture1, panner99 ).rgb;
			o.Alpha = 0.5;
		}
...
/*ASEBEGIN
Version=18900
0;23;1920;996;1232.727;-453.3381;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-296.0787,1145.118;Inherit;False;Property;_RippleSpeed;_RippleSpeed;1;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-607.6405,-829.2313;Inherit;False;Property;_TextureTiling1;Texture Tiling;5;0;Create;True;0;0;0;False;0;False;1;4;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-404.7085,371.5696;Inherit;False;Property;_RippleFrequency;_RippleFrequency;2;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;133;-37.83423,689.1497;Inherit;False;Property;_RippleAmplitude;_RippleAmplitude;10;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;91;-92.4518,-1084.239;Inherit;True;Property;_FlowMap1;FlowMap;8;0;Create;True;0;0;0;False;0;False;-1;28225c476c0b68c4cbae177d093a91e0;28225c476c0b68c4cbae177d093a91e0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;93;205.5221,-758.1928;Inherit;False;Property;_DistortionWeight1;DistortionWeight;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;193.9862,-466.0656;Inherit;False;Property;_PanSpeed1;PanSpeed;6;0;Create;True;0;0;0;False;0;False;0;0;0;14;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;96;233.0461,-601.4611;Inherit;False;Property;_PanDir1;PanDir;7;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;100;667.8917,-1111.745;Inherit;True;Property;_Texture1;Texture 0;3;0;Create;True;0;0;0;False;0;False;d79afcfe4ba835f45a39d670a0fa6fc6;d79afcfe4ba835f45a39d670a0fa6fc6;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;102;1293.216,-326.3261;Inherit;False;Constant;_Float1;Float 0;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=25928E801907B51CE9C3E8080C4F9492DA0992C5